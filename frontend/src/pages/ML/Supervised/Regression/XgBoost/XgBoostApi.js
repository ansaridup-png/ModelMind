...
const API_BASE = 'http://localhost:8080/api/xgboost';
...
export async function trainXgBoost(payload) {
...
export async function downloadXgBoostModel(artifactName) {
  const fileName =
    artifactName || 'xgboost-model.joblib';
