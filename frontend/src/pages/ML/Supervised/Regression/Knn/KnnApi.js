...
const API_BASE = 'http://localhost:8080/api/knn';
...
export async function trainKnn(payload) {
...
export async function downloadKnnModel(artifactName) {
  const fileName = artifactName || 'knn-model.joblib';
