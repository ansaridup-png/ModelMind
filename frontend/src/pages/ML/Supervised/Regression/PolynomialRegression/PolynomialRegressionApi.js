const API_BASE = 'http://localhost:8080/api/model/polynomial';
...
export async function trainPolynomialRegression(payload) {
...
export async function downloadPolynomialRegressionModel(artifactName) {
  const fileName =
    artifactName || 'polynomial-regression-model.joblib';
