...
const API_BASE = 'http://localhost:8080/api/svr';
...
export async function trainSvr(payload) {
...
export async function downloadSvrModel(artifactName) {
  const fileName = artifactName || 'svr-model.joblib';
